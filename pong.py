...
def discount_rewards(rewards, gamma):
   # Actions you took 20 steps before the end result are less important to the overall result than an action you took a step ago. This implements that logic by 
   # discounting the reward on previous actions based on how long ago they were taken
